...
KHASH_TYPE(ucp_worker_deferred_ep_hash, ucp_ep_h, ucp_worker_deferred_ep_data_t);
...
ucs_status_t
ucp_worker_flush_uct_ep_nb(ucp_ep_h ucp_ep, uct_ep_h uct_ep, ucp_request_t **req_p);
